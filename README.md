...
This repository contains minimal "Hello World" applications for a handful of different languages/frameworks for testing deployment to instances of [Cloud Foundry](https://www.cloudfoundry.org) ("CF") in general.
